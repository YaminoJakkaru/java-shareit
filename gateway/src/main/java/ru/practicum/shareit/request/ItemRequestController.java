...
public class ItemRequestController {
    ...
    @GetMapping
    public  ResponseEntity<Object> getAllUserRequests(@RequestHeader("X-Sharer-User-Id") @Positive int userId) {
        log.info("Getting all user requests");
        return itemRequestClient.getAllUserRequests(userId);
    }

    @GetMapping("/all")
    public  ResponseEntity<Object> getAll(@RequestHeader("X-Sharer-User-Id") @Positive int userId,
    ...
    public  ResponseEntity<Object> findRequestById(@RequestHeader("X-Sharer-User-Id") @Positive int userId,
